...
var cnItems = {
    ...
    "This portal will bring you to the": "传送门将带您到",
    ...
    "DIAMOND CHICKEN SWORD!!!": "钻石鸡剑！！！",
    "This diamond chicken meat is hardened to make it stronger, yay!": "这种钻石鸡肉经过硬化变得其更强壮了，耶！",
    "Yay! This awesome stuff is really awesome! :D": "耶！ 这个神器真是太棒了！ :D",
    "You are now equipped with diamond chicken boots": "你现在装备了钻石鸡鞋",
    "Diamond Chicken Sword": "钻石鸡剑",
    "The teleportation device has been placed": "传送装置已放置",
    "You are now equipped with diamond chicken helmet": "你现在装备了钻石鸡头盔",
    "Emerald Chicken": "翡翠鸡",
    "emerald chicken meat": "翡翠鸡肉",
    "Crazy Glitched Ch.": "疯狂的故障鸡",
    "Angry Emerald Ch.": "愤怒的翡翠鸡",
    "I'm ready for the chickenators! :D": "我已经准备好迎接小鸡了！ :D",
    "This emerald chicken meat is hardened to make it stronger, yay!": "这种翡翠鸡肉经过硬化处理，变得更强壮了，耶！",
    "You are now equipped with diamond chicken chestplate": "你现在装备了钻石鸡胸甲",
    "You are now equipped with emerald chicken boots": "你现在装备了翡翠鸡靴",
    "Emerald Chicken Sword": "翡翠鸡剑",
    "Available commands: go, pos, clear, examine, map, exit": "可用命令：go、pos、clear、examine、map、exit",
    "Diamond chicken nugget is very very delicious asdfhvryuiery": "钻石鸡块非常非常好吃 asdfhvryuiery",
    "Emerald chicken nugget is super delicious, although I believe emerald chicken nugget is more delicious, though": "翡翠鸡块超级好吃，虽然我觉得翡翠鸡块更好吃，不过",
    "You have destroyed a robot, too bad you don't get anything": "你摧毁了一个机器人，可惜你什么也没得到",
    "'go e': go east": "'go e'：向东走",
    "'go n': go north": "'go n'：向北走",
    "'go s': go south": "'go s'：向南走",
    "'go w': go west": "'go w'：向西走",
    "Chickenator 9999": "小鸡9999",
    "Crazy Chicken": "疯狂的普通鸡",
    "Crazy Emerald Ch.": "疯狂的翡翠鸡",
    "Crazy Iron Chicken": "疯狂的铁鸡",
    "Hmm.. it looks like a warp hole that warps you to somewhere...": "嗯..它看起来像一个扭曲的洞，将你扭曲到某个地方......",
    "In front of you there is a mysterious hole": "在你面前有一个神秘的洞",
    "north (↑),": "北 (↑),",
    "north (↑), east (→),": "北 (↑), 东 (→),",
    "north (↑), east (→), south (↓),": "北 (↑)、东 (→)、南 (↓)、",
    "north (↑), east (→), south (↓), west (←": "北 (↑)、东 (→)、南 (↓)、西 (←)",
    "north (↑), east (→), south (↓), west (←),": "北 (↑)、东 (→)、南 (↓)、西 (←)、",
    "north (↑), south (↓": "北 (↑)、南 (↓)",
    "north (↑), south (↓),": "北 (↑), 南 (↓),",
    "There are some chickens here... better kill them first before exploring further": "这里有一些鸡......在进一步探索之前最好先杀死它们",
    "Usage": "用法",
    "You are going forward to the hole...": "你正往洞里走……",
    "You are now here, at the Chickenverse 2.0": "你现在在这里，在小鸡宇宙 2.0",
    "You can also use arrow keys to move (but the input box must be focused": "也可以使用方向键移动（但输入框必须是焦点",
    "You can't go there": "你不能去那里",
    "You don't know where to go...": "你不知道去哪里...",
    "You entered the hole and you are teleported inside a cave, the cave has some rooms connected by doors and now you are insde one of the rooms": "你进入了洞，你被传送到了一个洞穴里，这个洞穴有一些房间由门相连，现在你在其中一个房间里",
    "You feel that the order of rooms inside this cave changes everytime you go here": "每次去都觉得这个洞里的房间顺序都变了",
    "You go to the north": "你前往北方",
    "Crazy Gold Chicken": "疯狂的金鸡",
    "Crazy Diamond Ch.": "疯狂的钻石鸡",
    "Bad idea, there is a wall here": "坏主意，这里有一堵墙",
    "Crazy Gold Chicken": "疯狂的金鸡",
    "east (→),": "东 (→),",
    "east (→), south (↓": "东 (→)、南 (↓)",
    "east (→), south (↓),": "东 (→), 南 (↓),",
    "east (→), south (↓), west (←": "东 (→)、南 (↓)、西 (←)",
    "east (→), south (↓), west (←),": "东 (→)、南 (↓)、西 (←)、",
    "east (→), west (←": "东 (→), 西 (←",
    "east (→), west (←),": "东 (→), 西 (←),",
    "Kill those chickens first": "先杀了那些鸡",
    "Nope don't go east, there is a wall": "不，别往东走，有一堵墙",
    "Nope don't go north, there is a wall": "不，别往北走，有一堵墙",
    "Nope don't go west, there is a wall": "不，别往西走，有一堵墙",
    "north (↑), east (→), south (↓": "北 (↑)、东 (→)、南 (↓)",
    "north (↑), south (↓), west (←": "北 (↑)、南 (↓)、西 (←)",
    "north (↑), south (↓), west (←),": "北 (↑)、南 (↓)、西 (←)、",
    "north (↑), west (←": "北 (↑)，西 (←",
    "north (↑), west (←),": "北 (↑), 西 (←),",
    "Oops, there is a wall!": "哎呀，有一堵墙！",
    "You can't go east anymore": "你不能再往东走",
    "You can't go north anymore": "你不能再北走",
    "You can't go west anymore": "你不能再往西走",
    "You go to the east": "你在往东走",
    "You go to the south": "你在往南走",
    "You go to the west": "你在往西走",
    "Examine what?": "检查什么？",
    "Log cleared": "日志已清除",
    "The map has been shown": "地图已显示",
    "Nope don't go south, there is a wall": "不，别往南走，有一堵墙",
    "north (↑), east (→), west (←": "北 (↑)、东 (→)、西 (←)",
    "north (↑), east (→), west (←),": "北 (↑)、东 (→)、西 (←)、",
    "south (↓),": "南 (↓),",
    "south (↓": "南 (↓",
    "west (←),": "西 (←),",
    "west (←": "西 (←",
    "Nope don't go south, there is a wall": "不，别往南走，有一堵墙",
    "You can't go south anymore": "你不能再南下",
    "This room has no torch inside while other rooms have torches, this is weird :/": "这个房间里面没有手电筒，而其他房间有手电筒，这很奇怪：/",
    "Trader wants to trade with you": "商人想与您交易",
    "Inventory area and tab showed up": "显示库存区域和选项卡",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnPrefix = {
    ...
    "HP: ": "生命值: ",
    "You killed a chicken with your fists and you got a piece of chicken meat. (You have ": "你用拳头杀死了一只鸡，你得到了一块鸡肉。 （你有 ",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^You found (.+) chicken nuggets inside a chest inside this room, you are lucky!$/, '你在这个房间的一个箱子里发现了 $1 鸡块，你很幸运！'],
    [/^You are at (.+) inside the cave$/, '你在洞穴内的 $1'],
